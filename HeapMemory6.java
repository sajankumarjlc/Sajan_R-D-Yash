...
public class HeapMemory6 {
	public static void main(String args[]) {
		...
		// returns false because str2 occupies space in string pool and str7 occupies
		// space in Java heap
		System.out.println((str2 == str7) + ", Strings are not equal.");
		// it returns true because we have invoked the intern() method and the String C
		// is already present in the string pool
